...
import VideoEditScreen from '../screens/VideoEditScreen';import ReservationScreen from '../screens/ReservationScreen';
...
const Tab = createBottomTabNavigator();function HomeStackScreen() {
 return (
